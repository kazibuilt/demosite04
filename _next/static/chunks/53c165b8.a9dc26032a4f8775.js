                        ...
                        V = function (t, r) {
                            for (var s, a, o, h, d, l, p = 0; p < r.length && !d;) {
                                ...
                                for (s = a = 0; s < f.length && !d;)
                                    if (d = f[s++].exec(t))
                                        for (o = 0; o < u.length; o++) l = d[++a], typeof (h = u[o]) === n && h.length > 0 ? 2 === h.length ? typeof h[1] == i ? this[h[0]] = h[1].call(this, l) : this[h[0]] = h[1] : 3 === h.length ? typeof h[1] !== i || h[1].exec && h[1].test ? this[h[0]] = l ? l.replace(h[1], h[2]) : e : this[h[0]] = l ? h[1].call(this, l, h[2]) : e : 4 === h.length && (this[h[0]] = l ? h[3].call(this, l.replace(h[1], h[2])) : e) : this[h] = l || e;
                                p += 2
                            }
                        },
                        Y = function (t, i) {
